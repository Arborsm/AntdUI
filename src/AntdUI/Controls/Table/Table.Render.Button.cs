        ...
        static void PaintButton(Graphics g, Font font, CellButton btn, Color color, Rectangle rect_read)
        {
            ...
            else
            {
                ...
                if (has_left || has_right)
                {
                    if (has_left && has_right)
                    {
                        rect_text = Render.IButton.RectAlignLR(g, btn.textLine, font, btn.IconPosition, btn.IconRatio, font_size, rect_read, out var rect_l, out var rect_r);
                    ...
                    {
                        rect_text = Render.IButton.RectAlignL(g, btn.textLine, font, btn.IconPosition, btn.IconRatio, font_size, rect_read, out var rect_l);

                        PaintButtonPaintImage(g, btn, color, rect_l);
                    }
                    else
                    {
                        rect_text = Render.IButton.RectAlignR(g, btn.textLine, font, btn.IconPosition, btn.IconRatio, font_size, rect_read, out var rect_r);
